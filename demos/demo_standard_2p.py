...
This runs the full pipeline: initialization, registration, correlation map,
segmentation, neuropil mask computation, trace extraction, and deconvolution.

Diagnostic figures are saved to the job directory after each step.
...
Usage:
    ...
    python demos/demo_standard_2p.py --output_dir /path/to/output --job_id my_job --skip_init --skip_register
"""
